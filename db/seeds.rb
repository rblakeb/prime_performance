...
Admin.create(first_name: 'Blake', last_name: 'Barnes', email: 'blake@primeperformancesc.com', password: 'password')

batman = Blog.create! name: "Batman", content: <<-Blog
...
superman = Blog.create! name: "Superman", content: <<-Blog
...
krypton = Blog.create! name: "Krypton", content: <<-Blog
...
lex_luthor = Blog.create! name: "Lex Luthor", content: <<-Blog
...
robin = Blog.create! name: "Robin", content: <<-Blog
